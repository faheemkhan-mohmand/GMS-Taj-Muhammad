 ...
 *   https://gmstajmuhammad.indevs.in/admission/verify?ref=OHS-2026-0001
 *
 * The card includes:
...
const SITE_URL = "https://gmstajmuhammad.indevs.in";
  ...
  const generatePDF = async (download: boolean = false) => {
    ...
    try {
      ...
      const instructions = [
        ...
        "5. For queries, call 0346-9898295 or visit gmstajmuhammad.indevs.in",
      ];
      y += 4;
