...
//
// SETUP (one-time):
//   1. Go to https://plausible.io → "Add a website" → enter gmstajmuhammad.indevs.in
//   2. Copy your domain (e.g. "gmstajmuhammad.indevs.in") into VITE_PLAUSIBLE_DOMAIN
...
//   VITE_PLAUSIBLE_DOMAIN=gmstajmuhammad.indevs.in
